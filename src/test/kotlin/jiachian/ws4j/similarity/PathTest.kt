 ...
 * @author Hideki Shima
 */
class PathTest : RelatednessCalculatorTest() {
    @Test
    override fun testHappyPathOnSynsets() {
        assertEquals(0.5000, rc.calcRelatednessOfSynsets(cycloneConcepts[1], hurricaneConcepts[0]).score, 0.0001)
        assertEquals(0.1250, rc.calcRelatednessOfSynsets(cycloneConcepts[0], hurricaneConcepts[0]).score, 0.0001)
        assertEquals(0.5000, rc.calcRelatednessOfSynsets(migrateConcepts[0], emigrateConcepts[0]).score, 0.0001)
        assertEquals(0.2500, rc.calcRelatednessOfSynsets(migrateConcepts[1], emigrateConcepts[0]).score, 0.0001)
    }
    ...
    override fun testHappyPathOnWords() {
        assertEquals(0.5000, rc.calcRelatednessOfWords(CYCLONE, HURRICANE), 0.0001)
        assertEquals(0.5000, rc.calcRelatednessOfWords(MIGRATE, EMIGRATE), 0.0001)
    }
